...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/05e4efd0245a4a7643d7f.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/05e4efd0245a4a7643d7f.jpg"
)
...
QUEUE_PIC = (
    os.environ.get("QUEUE_PIC") or "https://telegra.ph/file/05e4efd0245a4a7643d7f.jpg"
)
...
with bot:
    try:
        ...
        main_help_button = [
            ...
            [
                Button.url("📣 Updates", f"https://t.me/wyzchannel"),
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**🕹️ Wyz-Userbot Inline Menu 🕹️**\n\n🧸 **Owner :** [{user.first_name}](tg://user?id={user.id})\n🔮 **Jumlah :** `{len(dugmeler)}` **Modules**",
                await event.edit(
                    text,
                    file=ciliklogo,
                    buttons=buttons,
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@whyzuserbot"):
                buttons = paginate_help(0, dugmeler, "helpme")
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository Wyz - Userbot",
                    url="https://t.me/Wyzsupport",
                ...
                result = builder.article(
                    title="✨ Wyz-Userbot ✨",
                    description="Wyz - Userbot | Telethon",
                    url="https://t.me/wyzsupport",
                    thumb=InputWebDocument(
                        ALIVE_LOGO,
                        0,
