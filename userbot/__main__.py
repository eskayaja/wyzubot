...
LOGS.info(
    f"Jika {user.first_name} Membutuhkan Bantuan, Silahkan Tanyakan di Grup https://t.me/wyzsupport")
LOGS.info(
    f"🔥 Wyz-Userbot 🔥 ⚙️ V{BOT_VER} [TELAH DIAKTIFKAN!]")
    ...
    try:
        if BOTLOG_CHATID != 0:
            await bot.send_file(
                BOTLOG_CHATID,
                ALIVE_LOGO,
                caption=f"🔥 **Wyz Userbot Berhasil Diaktifkan**!!\n━━━━━━━━━━━━━━━\n➠ **Userbot Version** - 1.1 @Wyz-Userbot\n➠ **Ketik** `.ping` **Untuk Mengecheck Bot**\n━━━━━━━━━━━━━━━\n➠ **Powered By:** @WyzSupport ",
            )
    except Exception as e:
        LOGS.info(str(e))
    try:
